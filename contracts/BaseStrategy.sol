...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    function deposit(address _userAddress, uint _wantBefore, uint256 _wantAmt) external onlyOwner nonReentrant whenNotPaused returns (uint256 tokensAdded) {
        ...
        require(wantLocked > _wantBefore, "low or bad deposit, nothing added");
        return wantLockedTotal() - _wantBefore;
